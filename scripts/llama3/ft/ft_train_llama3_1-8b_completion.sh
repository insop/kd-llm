...
# Config file
CONFIG_FILE="ft/8B_lora_llama3_2_completion.yaml"

# =========
## EXPERIMENT PARAMETERS
# update
# =========
DATASET_SOURCE="codeparrot/codeparrot-train-more-filtering"
MAX_SEQ_LEN=1024
BATCH_SIZE=10
...
CONFIG_OPTIONS+=" dataset.source=$DATASET_SOURCE"
CONFIG_OPTIONS+=" tokenizer.max_seq_len=$MAX_SEQ_LEN"
CONFIG_OPTIONS+=" batch_size=$BATCH_SIZE"
CONFIG_OPTIONS+=" max_steps_per_epoch=$MAX_STEPS_PER_EPOCH"
